    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        for i, (imgs, targets, paths, _) in pbar:  # batch -------------------------------------------------------------
            ...
            if opt.multi_scale and not opt.rect:
                sz = random.randrange(imgsz * 0.875, imgsz * 1.25 + gs) // gs * gs  # size
...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default=ROOT / 'yolov7.pt', help='initial weights path')
    ...
    parser.add_argument('--hyp', type=str, default=ROOT / 'DOTA/dotas.yaml', help='hyperparameters path')
